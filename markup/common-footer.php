<footer>
    <div class="main-wrapper">
        <div class="inner-wrapper">
            <div class="footer">
                <div class="copyright">
                    &copy; Michael Seifert
                </div>
                <ul class="social-media-list">
                    <li>
                        <a target="_blank"
                           href="https://www.youtube.com/channel/UCA_7a4xD6uUHgzY7vLZUv0g">
                    ...
                    <li>
                        <a target="_blank" href="https://soundcloud.com/michael-seifert-90">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="soundcloud"
                                 class="svg-inline--fa fa-soundcloud fa-w-20" role="img"
